...
from update_status_handlers import update_status, handle_update_status
...
async def button(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    elif query.data == 'update_status_selection':
        await query.message.reply_text("請輸入新的狀態:")
        context.user_data['action'] = 'update_status'
    elif query.data == 'update_location_selection':
        await query.message.reply_text("請輸入新的位置:")
        context.user_data['action'] = 'update_location'
